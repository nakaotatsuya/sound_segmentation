...
if __name__ == "__main__":
    ...
    #save_dir = osp.join("results", dataset_name, "2021_1222_supervised_ssls_UNet")
    #save_dir = osp.join("results", dataset_name, "2022_0104_supervised_ssls_UNet")
    save_dir = osp.join("results", dataset_name, "2022_0127_supervised_ssls_UNet")
