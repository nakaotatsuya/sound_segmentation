...
def train():
    train_dataset = SoundSegmentationDataset_2D(dataset_dir, split="noise_train2", task=task, n_classes=n_classes, spatial_type=spatial_type, mic_num=mic_num, angular_resolution=angular_resolution, input_dim=input_dim)
